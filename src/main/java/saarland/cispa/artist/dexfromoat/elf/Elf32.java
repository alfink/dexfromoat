...
public class Elf32 extends Elf {
    ...
    public Elf32(RandomAccessFile elffile) throws IOException, ParseException {
    ...
    class Symbol32 extends ISymbol {

        Symbol32(long offset) throws IOException, ParseException {
